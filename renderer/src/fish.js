...
export async function loadSkin(name) {
  ...
  if (metaFromMain && Object.keys(metaFromMain).length) {
    ...
    skin.animations = Object.assign(
      skin.animations,
      metaFromMain.animations || {},
    );
    skin.animFPS = metaFromMain.fps || skin.animFPS;
    skin.drawOffsetX =
      (metaFromMain.drawOffset && metaFromMain.drawOffset.x) || 0;
    skin.drawOffsetY =
      (metaFromMain.drawOffset && metaFromMain.drawOffset.y) || 0;
