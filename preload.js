...
contextBridge.exposeInMainWorld('api', {
  ...
  robotMove: (dx, dy, smooth = true) => ipcRenderer.invoke('robot-move', dx, dy, smooth),
  ...
  onActiveWindowBounds: (callback) => ipcRenderer.on('active-window-bounds', (event, bounds) => callback(bounds))
});
